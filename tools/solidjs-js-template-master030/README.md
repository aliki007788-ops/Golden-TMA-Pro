...
> required to use it for this project as well.
...
➜  Local:   https://localhost:5173/solidjs-js-template
➜  Network: https://172.18.16.1:5173/solidjs-js-template
➜  Network: https://172.19.32.1:5173/solidjs-js-template
➜  Network: https://192.168.0.171:5173/solidjs-js-template
...
link (`https://localhost:5173/solidjs-js-template` in this example) in your
browser.
...
application rapidly. Alternatively, you could
use such services as [Heroku](https://www.heroku.com/)
